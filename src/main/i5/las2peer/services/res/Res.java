...
public class Res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "1000", version = "$Metadata_Version$",
          description = "$Metadata_Description$",
          termsOfService = "$Metadata_Terms$",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-1000/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  @ApiResponses(value = {
       @ApiResponse(code = HttpURLConnection.HTTP_OK, message = "se")
  })
  ...
  public Response me() {
    ...
    // se
    boolean se_condition = true;
    if(se_condition) {
      JSONObject ew = new JSONObject();

      

      return Response.status(HttpURLConnection.HTTP_OK).entity(ew.toJSONString()).build();
    }
    return null;
  }
